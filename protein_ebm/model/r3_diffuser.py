# based off of https://github.com/jasonkyuyim/se3_diffusion, MIT License, Copyright (c) 2022 Jason Yim, Brian L Trippe, Valentin De Bortoli, Emile Mathieu
...
class R3Diffuser:
    ...
    def _scale(self, x):
        return x * self.config.coordinate_scaling
    ...
    def calc_trans_0(self, score_t, x_t, t, use_torch=True):
        ...
        x0 = (score_t * cond_var + x_t) / exp_fn(-1/2*beta_t)
        return self._unscale(x0)
